...
describe('Login Page', () => {
  ...
  it('should show login form', async () => {
    ...
    await rootContainer.findAllByText('Tio Boot');
    ...
    expect(rootContainer.baseElement?.querySelector('.ant-pro-form-login-desc')?.textContent).toBe(
      'Tio Boot is the most influential web design specification in Xihu district',
    );
  ...
  it('should login success', async () => {
    ...
    await rootContainer.findAllByText('Tio Boot Admin');
